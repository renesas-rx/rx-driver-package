...
typedef enum 			// Wi-Fi APIエラーコード
{
	...
	WIFI_ERR_SERIAL_OPEN    = -3,	// シリアルの初期化ができません。
	WIFI_ERR_MODULE_COM     = -4,	// WiFiモジュールとの通信に失敗しました。
	WIFI_ERR_SOCKET_NUM     = -5,	// 利用可能なソケットがありません。
	WIFI_ERR_SOCKET_CREATE  = -6,	// ソケットを作成できません。
	WIFI_ERR_CHANGE_SOCKET  = -7,	// ソケットを切り替えられません。
	WIFI_ERR_SOCKET_CONNECT = -8,	// ソケットに接続できません。
	WIFI_ERR_SOCKET_BYTEQ   = -9,	// BYTEQの割り当てに失敗しました。
	WIFI_ERR_SOCKET_TIMEOUT = -10,	// ソケットの送信でタイムアウトしました。
	WIFI_ERR_TAKE_MUTEX     = -11,	// Mutexの取得に失敗しました。
} wifi_err_t;
