...
#define WIFI_UART_BOUDRATE_DEFAULT      115200
typedef enum
{
...
typedef enum
{
    WIFI_SOCKET_STATUS_CLOSED=0,	//�N���[�Y���
    WIFI_SOCKET_STATUS_SOCKET,		//�쐬�������
    WIFI_SOCKET_STATUS_BOUND,		//BOUND���
    WIFI_SOCKET_STATUS_LISTEN,		//LISTEN���
    WIFI_SOCKET_STATUS_CONNECTED,	//�R�l�N�g���
    WIFI_SOCKET_STATUS_MAX,			//�X�e�[�^�X���̏����
} wifi_socket_status_t;

typedef enum
{
	ESP32_COMMAND_NONE = 0,
	ESP32_SET_REBOOT,
	ESP32_SET_ECHO_OFF,
	ESP32_SET_UART_HISPEED,
	ESP32_SET_WIFI_DISCONNECT,
	ESP32_SET_DNS_SRV_ADDRESS,
	ESP32_SET_STATIC_IP,
	ESP32_SET_WIFI_AUTOCONNECT,
	ESP32_SET_WIFI_ACT_MODE,
	ESP32_SET_DHCP_MODE,
	ESP32_SET_MULTIPLE_SOCKET,
	ESP32_SET_WIFI_CONNECT,
	ESP32_SET_DNSQUERY,
	ESP32_SET_PING,
	ESP32_SET_SSLCONFIG,
	ESP32_SET_SOCKET_CONNECT,
	ESP32_SET_SOCKET_SEND_START,
	ESP32_SET_SOCKET_SEND_DATA,
	ESP32_SET_SOCKET_CLOSE,
	ESP32_GET_MODULE_VERSION,
	ESP32_GET_UART_BAUDRATE,
	ESP32_GET_APLIST,
	ESP32_GET_MACADDRESS,
	ESP32_GET_IPADDRESS,
	ESP32_LIST_MAX
}wifi_command_list_t;
...
typedef struct
{
	...
	uint8_t     *comannd_buff;
	uint32_t    comannd_buff_size;
