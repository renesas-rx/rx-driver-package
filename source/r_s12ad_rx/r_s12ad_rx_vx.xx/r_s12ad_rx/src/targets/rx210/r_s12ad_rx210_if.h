...
***********************************************************************************************************************/
/**********************************************************************************************************************
* File Name    : r_s12ad_rx210_if.h
* Description  : 12-bit A/D Converter driver interface file for RX210.
***********************************************************************************************************************
...
#ifndef S12AD_RX210_IF_H
#define S12AD_RX210_IF_H
...
typedef enum e_adc_trig             // trigger sources (set to TRSA bit or TRSB bit)
{
    ...
    ADC_TRIG_SYNC_TEMPS             = 10,   // for temperature sensor, use ADC_TRIG_SOFTWARE
...
#define ADC_DDA_STATE_CNT_MIN       (1)
...
#define ADC_SST_SH_CNT_DEFAULT  (20)    // default sample&hold states
