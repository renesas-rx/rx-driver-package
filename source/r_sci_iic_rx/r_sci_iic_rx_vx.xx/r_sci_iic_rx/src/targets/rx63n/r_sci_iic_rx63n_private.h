 ...
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : r_sci_iic_rx63n_private.h
...
#ifndef SCI_IIC_RX63N_PRIVATE_H
    #define SCI_IIC_RX63N_PRIVATE_H
/***********************************************************************************************************************
...
/* Sets to use multi-function pin controller. */
        ...
        #define SCI_IIC_MPC_SSCL_INIT       ((uint8_t)(0x00))   /* Pin function select to Hi-Z */
            ...
            #define SCI_IIC_MPC_SSDA10_ENABLE   ((uint8_t)(0x0A))   /* Pin function select to SCI10 SSDA pin:b01010 */
            #define SCI_IIC_MPC_SSCL10_ENABLE   ((uint8_t)(0x0A))   /* Pin function select to SCI10 SSCL pin:b01010 */
        #endif /* #ifdef SCI_IIC_CFG_CH10_INCLUDED */

        #if SCI_IIC_CFG_CH11_INCLUDED
            #define SCI_IIC_MPC_SSDA11_ENABLE   ((uint8_t)(0x0A))   /* Pin function select to SCI11 SSDA pin:b01010 */
            #define SCI_IIC_MPC_SSCL11_ENABLE   ((uint8_t)(0x0A))   /* Pin function select to SCI11 SSCL pin:b01010 */
...
typedef struct st_sci_iic_ch_rom /* SCI ROM info for channel control block */
{
    ...
    volatile __evenaccess uint8_t  * pir_tei; /* ptr to TEI IR register */
    ...
    volatile __evenaccess uint8_t  * picu_tei;
