...
const baud_divisor_t scif_async_baud[NUM_DIVISORS_ASYNC]=
{
...
const baud_divisor_t scif_sync_baud[NUM_DIVISORS_SYNC]=
{
...
/* rom info */
const scif_ch_rom_t scif_ch8_rom = {(volatile __evenaccess struct st_scifa *)&SCIFA8,
                                BIT27_MASK,
...
scif_ch_ctrl_t scif_ch8_ctrl = {&scif_ch8_rom, SCIF_MODE_OFF, 0, NULL,
                                0, 0, 0, 0,
                                NULL, NULL, 0, 0,
                                NULL, NULL, 0, 0,
                                true, false
...
/* rom info */
const scif_ch_rom_t scif_ch9_rom = {(volatile __evenaccess struct st_scifa *)&SCIFA9,
                                BIT26_MASK,
...
/* channel control block */
scif_ch_ctrl_t  scif_ch9_ctrl = {&scif_ch9_rom, SCIF_MODE_OFF, 0, NULL,
                                0, 0, 0, 0,
                                NULL, NULL, 0, 0,
                                NULL, NULL, 0, 0,
                                true, false
...
/* rom info */
const scif_ch_rom_t scif_ch10_rom = {(volatile __evenaccess struct st_scifa *)&SCIFA10,
                                BIT25_MASK,
...
/* channel control block */
scif_ch_ctrl_t  scif_ch10_ctrl = {&scif_ch10_rom, SCIF_MODE_OFF, 0, NULL,
                                0, 0, 0, 0,
                                NULL, NULL, 0, 0,
                                NULL, NULL, 0, 0,
                                true, false
...
/* rom info */
const scif_ch_rom_t scif_ch11_rom = {(volatile __evenaccess struct st_scifa *)&SCIFA11,
                                BIT24_MASK,
...
/* channel control block */
scif_ch_ctrl_t  scif_ch11_ctrl = {&scif_ch11_rom, SCIF_MODE_OFF, 0, NULL,
                                0, 0, 0, 0,
                                NULL, NULL, 0, 0,
                                NULL, NULL, 0, 0,
                                true, false
