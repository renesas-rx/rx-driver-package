...
{
    volatile  __evenaccess struct st_scifa  *regs;  // base ptr to ch registers
...
#endif
    volatile  __evenaccess uint8_t  *ipr_rxif;   	// ptr to RXIF IPR register
    volatile  __evenaccess uint8_t  *ipr_txif;   	// ptr to TXIF IPR register
    volatile  __evenaccess uint8_t  *ir_rxif;    	// ptr to RXIF IR register
    volatile  __evenaccess uint8_t  *ir_txif;    	// ptr to TXIF IR register
    volatile  __evenaccess uint8_t  *ier_rxif;      // ptr to RXIF IER register
    volatile  __evenaccess uint8_t  *ier_txif;      // ptr to TXIF IER register
...
{
    uint8_t     *tx_buf;            // user's buffer
    uint8_t     *rx_buf;            // user's buffer
...
{
    scif_ch_rom_t const *rom;       // pointer to rom info
...
******************************************************************************/
#if (SCIF_CFG_ASYNC_INCLUDED)
extern const baud_divisor_t scif_async_baud[];
#endif
#if (SCIF_CFG_SYNC_INCLUDED)
extern const baud_divisor_t scif_sync_baud[];
#endif
...
extern const scif_ch_rom_t      scif_ch8_rom;
extern scif_ch_ctrl_t           scif_ch8_ctrl;
#endif

#if SCIF_CFG_CH9_INCLUDED
extern const scif_ch_rom_t      scif_ch9_rom;
extern scif_ch_ctrl_t           scif_ch9_ctrl;
#endif

#if SCIF_CFG_CH10_INCLUDED
extern const scif_ch_rom_t      scif_ch10_rom;
extern scif_ch_ctrl_t           scif_ch10_ctrl;
#endif

#if SCIF_CFG_CH11_INCLUDED
extern const scif_ch_rom_t      scif_ch11_rom;
extern scif_ch_ctrl_t           scif_ch11_ctrl;
#endif
