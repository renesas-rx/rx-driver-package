...
***********************************************************************************************************************/
#ifndef LVD_RX631_HEADER_FILE
#define LVD_RX631_HEADER_FILE
...
#define LVD_GROUP_SETUP                         (LVD_GROUP_SETUP_LVDA_1)

/* Group: ICU group */
#define LVD_GROUP_INT                           (LVD_GROUP_INT_ICUb)

/* Support: Maskable interrupt */
#define LVD_SUPPORT_MI_CH1                      (LVD_DISABLE)
#define LVD_SUPPORT_MI_CH2                      (LVD_DISABLE)
...
#define LVD_VOLTAGE_LEVEL_DEFAULT_VALUE_CH2     (10)

/* Convert: Voltage level: Setting value -> register value */
#if (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_1 == 295)
...
#if (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_2 == 295)
...
#define LVD_DFILTER_DIV_DEFAULT_CH1             (1)
#define LVD_DFILTER_DIV_DEFAULT_CH2             (1)
...
#if (LVD_CFG_SAMPLING_CLOCK_CHANNEL_1 == 1)
    #define LVD_DFILTER_DIV_VALUE_CH1           (0)
#elif (LVD_CFG_SAMPLING_CLOCK_CHANNEL_1 == 2)
...
#if (LVD_CFG_SAMPLING_CLOCK_CHANNEL_2 == 1)
    #define LVD_DFILTER_DIV_VALUE_CH2           (0)
#elif (LVD_CFG_SAMPLING_CLOCK_CHANNEL_2 == 2)
...
#define LVD_DELAY_CIRCUIT_ENABLE_USEC           (3)
