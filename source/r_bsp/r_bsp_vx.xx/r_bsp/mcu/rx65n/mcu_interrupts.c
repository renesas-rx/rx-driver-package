...
*         : xx.xx.xxxx 3.00      Deleted the following functions. 
...
***********************************************************************************************************************/
R_BSP_PRAGMA_INTERRUPT(group_bl0_handler_isr, VECT(ICU,GROUPBL0))
R_BSP_PRAGMA_INTERRUPT(group_bl1_handler_isr, VECT(ICU,GROUPBL1))
R_BSP_PRAGMA_INTERRUPT(group_bl2_handler_isr, VECT(ICU,GROUPBL2))
R_BSP_PRAGMA_INTERRUPT(group_al0_handler_isr, VECT(ICU,GROUPAL0))
R_BSP_PRAGMA_INTERRUPT(group_al1_handler_isr, VECT(ICU,GROUPAL1))
...
* Return Value : None
***********************************************************************************************************************/
R_BSP_ATTRIB_INTERRUPT void group_bl0_handler_isr (void)
{
...
* Return Value : None
***********************************************************************************************************************/
R_BSP_ATTRIB_INTERRUPT void group_bl1_handler_isr (void)
{
...
* Return Value : None
***********************************************************************************************************************/
R_BSP_ATTRIB_INTERRUPT void group_bl2_handler_isr (void)
{
...
* Return Value : None
***********************************************************************************************************************/
R_BSP_ATTRIB_INTERRUPT void group_al0_handler_isr (void)
{
...
* Return Value : None
***********************************************************************************************************************/
R_BSP_ATTRIB_INTERRUPT void group_al1_handler_isr (void)
{
