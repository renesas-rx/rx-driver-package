...
#define T4_CFG_ETHER_CH1_MAC_ADDRESS                      0x74,0x90,0x50,0x00,0x79,0x03
...
#define T4_CFG_TCP_CEPID1_CALLBACK_FUNCTION_NAME_TMP      (t4_tcp_callback)
...
#define T4_CFG_TCP_CEPID2_CALLBACK_FUNCTION_NAME_TMP      (t4_tcp_callback)
...
#define T4_CFG_TCP_CEPID3_CALLBACK_FUNCTION_NAME_TMP      (t4_tcp_callback)
...
#define T4_CFG_TCP_CEPID4_CALLBACK_FUNCTION_NAME_TMP      (t4_tcp_callback)
...
#define T4_CFG_TCP_CEPID5_CALLBACK_FUNCTION_NAME_TMP      (t4_tcp_callback)
...
#define T4_CFG_TCP_CEPID6_CALLBACK_FUNCTION_NAME_TMP      (t4_tcp_callback)
...
#define T4_CFG_UDP_CEPID1_CALLBACK_FUNCTION_NAME_TMP      (t4_udp_callback)
...
#define T4_CFG_UDP_CEPID2_CALLBACK_FUNCTION_NAME_TMP      (t4_udp_callback)
...
#define T4_CFG_UDP_CEPID3_CALLBACK_FUNCTION_NAME_TMP      (t4_udp_callback)
...
#define T4_CFG_UDP_CEPID4_CALLBACK_FUNCTION_NAME_TMP      (t4_udp_callback)
...
#define T4_CFG_UDP_CEPID5_CALLBACK_FUNCTION_NAME_TMP      (t4_udp_callback)
...
#define T4_CFG_UDP_CEPID6_CALLBACK_FUNCTION_NAME_TMP      (t4_udp_callback)
