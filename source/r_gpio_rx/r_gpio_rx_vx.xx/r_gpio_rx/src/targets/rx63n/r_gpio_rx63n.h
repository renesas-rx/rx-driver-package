...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_gpio_rx63n.h
* Description  : Specifics for the r_gpio_rx driver for the RX63N.
***********************************************************************************************************************/
/***********************************************************************************************************************
* History : DD.MM.YYYY Version Description
*         : 18.02.2014 1.10    First Release
*         : 02.05.2015 1.20    Corrected mistakes in table gpio_pin_bit_mask_t
*         :                    Added DSCR support
*         : 03.06.2015 1.21    Fixed an error in the definition for GPIO_PRV_BASE_ADDR_DSCR.
*         : 24.04.2015 1.22    Added the compiler directive: "#if defined(BSP_MCU_RX63N)"
***********************************************************************************************************************/
#ifndef GPIO_RX63N
#define GPIO_RX63N
...
#include "platform.h"
#if defined(BSP_MCU_RX63N)  //Prevents the compiler from finding multiple definitions of constant in this file.
...
#else
    #error "r_gpio_rx does not have information about this RX63N package. Please update r_gpio_rx63n.h"
#endif
...
#define GPIO_DSCR_IS_SUPPORTED    //High-drive is supported for the RX63n
...
typedef enum
{
    GPIO_PORT0_PIN_MASK = 0x00,    /* None                                      */
    GPIO_PORT1_PIN_MASK = 0xF0,    /* Available pins: P14 to P17                */
    GPIO_PORT2_PIN_MASK = 0xC0,    /* Available pins: P26, P27                  */
    GPIO_PORT3_PIN_MASK = 0xE3,    /* Available pins: P30, P31, P35 to P37      */
    GPIO_PORT4_PIN_MASK = 0x47,    /* Available pins: P40 to P42, P46           */
    GPIO_PORT5_PIN_MASK = 0x00,    /* None                                      */
    GPIO_PORT6_PIN_MASK = 0x00,    /* None                                      */
    GPIO_PORT7_PIN_MASK = 0x00,    /* None                                      */
    GPIO_PORT8_PIN_MASK = 0x00,    /* None                                      */
    GPIO_PORT9_PIN_MASK = 0x00,    /* None                                      */
